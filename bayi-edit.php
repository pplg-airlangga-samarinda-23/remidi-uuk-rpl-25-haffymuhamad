...
if ($_SERVER['REQUEST_METHOD']=== 'POST') {
    ...
    $row = $oneksi->execute_query($sql, [$nama, $nama_ibu, $nama_ayah, $tanggal_lahir, $id_bayi]);
...
<body>
    ...
    <form action=** method="post">
        ...
        <div class="form-item">
            <label for="tanggal_lahiar">Tanggal</label>
            <input type="text" name="tanggal_lahir" id="tanggal_lahir" value="<?=$baby['tanggal_lahir']?>">
        </div>
